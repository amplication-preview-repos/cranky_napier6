...
@InputType()
class AssignmentCreateNestedManyWithoutApplicationsInput {
...
export { AssignmentCreateNestedManyWithoutApplicationsInput as AssignmentCreateNestedManyWithoutApplicationsInput };
